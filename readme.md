...
- Если выдается ошибка 400 Bad Request или 403 Forbidden, при попытке установки видео с YouTube, то необходимо использовать прокси, подробнее https://github.com/yt-dlp/yt-dlp (обычно проблема на хостингах)
- Если не устанавливаются видео, то необходим хостинг на иностранном ip-адресе или смена региона на своей локальной машине с помощью сторонних программ
...
Отдельного упоминания и благодарственных слов заслуживает разработчики пакетов yt-dlp и ffmpeg, без их творений не получилось бы реализовать своего бота.
- Ссылка на yt-dlp: https://github.com/yt-dlp/yt-dlp
- Ссылка на ffmpeg: https://github.com/FFmpeg/FFmpeg